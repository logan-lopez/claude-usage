# AGENTS.md — Instructions for AI Agents in `claude-usage`
...
Welcome to the **claude-usage** repository. When working in this codebase, you must follow the memory conventions:
